...
## 🆕 Новая функциональность: Экспорт отчётов (v1.1.0)

### ✨ Возможности
- 📋 **Предпросмотр отчётов** в админ-панели со встроенным просмотром
- 📄 **Экспорт в PDF** — профессиональное оформление, готово для печати
- 📝 **Экспорт в TXT** — текстовый формат для копирования
- 🎨 **Читаемый формат** — структурированный отчёт без технических деталей
...
# → Сессии опросов → Кнопки: Просмотр | PDF | TXT
```

### 📚 Документация
- [Руководство по экспорту отчётов](EXPORT_REPORTS.md)
- [Инструкция по развёртыванию обновления](DEPLOYMENT_UPDATE.md)
- [Быстрая шпаргалка](QUICKSTART_EXPORT.md)
- **[🔥 Интеграция с Битрикс24 (полная инструкция)](BITRIX24_INTEGRATION.md)**
- **[📱 Автоматическая отправка ссылок (WhatsApp/SMS/Telegram)](MESSAGING_SETUP.md)**
- **[📊 Мониторинг логов системы](LOGS_MONITORING.md)** ⭐ Новое!
- [Информация о сервере](SERVER_INFO.md)
